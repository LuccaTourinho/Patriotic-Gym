...
const HeroSliderComponent: React.FunctionComponent<IHeroSliderComponentProps> = (props) => {
  return (
    <div className='h-full flex flex-col pt-48'>
        <h1 className='text-5xl font-roboto-slab text-[#B31942] text-center lg:text-left mb-2 uppercase'>
            End fat tyranny, <br /> 
        ...
        <p className='text-sm font-oswald text-[#B31942] text-center lg:text-left font-extrabold'>
        ...
        <div className='flex justify-center lg:justify-start'>
            <Button
                variant={'default'}
                className={`
                    mt-8 w-32 text-center bg-[#B31942] text-[#F2F2F2] rounded-none
            ...
            >
                <Link href={''}>
                    <span className="relative z-10 text-white uppercase">Get Started</span>
                </Link>
            </Button>
        </div>
    </div>
