...
const HeroSliderComponent: React.FunctionComponent<IHeroSliderComponentProps> = (props) => {
  return (
    <div className='h-full flex flex-col pt-48'>
        <h1 className='text-5xl font-roboto-slab text-[#6C2E04] text-center lg:text-left mb-2 uppercase'>
            End fat tyranny, <br /> 
        ...
        <p className='text-sm font-oswald text-[#6C2E04] text-center lg:text-left font-extrabold'>
